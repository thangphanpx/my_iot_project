...
class SensorCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final latestSensorDataProvider =
        ref.watch(deviceLatestSensorDataProvider(deviceId));
    ...
    if (sensorType != null) {
      latestData = sensorData
          .where((data) => data.deviceId == deviceId && data.type == sensorType)
          .lastOrNull;
    } else {
      latestData = latestSensorDataProvider;
    }
